...
internal class CustomerRepository(BankSystemDbContext context) : RepositoryBase<Customer>(context), ICustomerRepository
{
    public async Task<Customer?> GetByEmailAsync(string email, CancellationToken cancellationToken = default)
    {
        return await DbSet.FirstOrDefaultAsync(c => c.Email == email && c.IsActive, cancellationToken);
    }
    ...
    {
        return await DbSet.FirstOrDefaultAsync(c => c.NationalId == nationalId || c.Email == email && c.IsActive, cancellationToken);
    }
    ...
    public async Task<Customer?> GetByNationalIdAsync(string nationalId, CancellationToken cancellationToken = default)
    {
        return await DbSet
            ...
            .FirstOrDefaultAsync(c => c.NationalId == nationalId && c.IsActive, cancellationToken);
    }
