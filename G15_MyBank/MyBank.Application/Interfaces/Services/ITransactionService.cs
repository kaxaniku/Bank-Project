...
namespace MyBank.Application.Interfaces.Services
{
    internal interface ITransactionService 
    {
        ...
        Task<IEnumerable<Transaction>> GenerateStatementAsync(int accountId, DateTime fromDate, DateTime toDate, CancellationToken token);
        ...
        Task<IEnumerable<Transaction>> GetTransactionsAsync(int accountId, CancellationToken token);
