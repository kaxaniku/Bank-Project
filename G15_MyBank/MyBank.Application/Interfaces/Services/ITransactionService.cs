...
public interface ITransactionService
{
    ...
    IEnumerable<Transaction> ListTransactions(string toAccountNum, TransactionType type, int pageNumber = 1);
    Task<IEnumerable<Transaction>> ListTransactionsAsync(string toAccountNum, TransactionType type ,CancellationToken cancellationToken, int pageNumber = 1);
